  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "brand-md":
          "0 4px 12px rgba(var(--brand-primary-rgb, 0, 56, 90), 0.10)",
        "brand-lg":
          "0 8px 24px rgba(var(--brand-primary-rgb, 0, 56, 90), 0.12)",
        "brand-xl":
          "0 12px 32px rgba(var(--brand-primary-rgb, 0, 56, 90), 0.15)",
        // Card Shadows (語意化)
        card: "0 2px 8px rgba(var(--brand-primary-rgb, 0, 56, 90), 0.06)",
        "card-hover": "0 10px 26px rgba(13, 39, 94, 0.12)",
        "card-glow":
          "0 4px 20px rgba(var(--brand-primary-rgb, 0, 56, 90), 0.03)",
      ...
      animation: {
        ...
        /** 桌面漂浮 - 較大幅度 */
        "float-desktop":
          "floatDesktop 3s cubic-bezier(0.45, 0, 0.55, 1) infinite",
        /** 慢彈跳 - 輕微彈跳效果 */
