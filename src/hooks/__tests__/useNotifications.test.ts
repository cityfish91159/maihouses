...
const createMockConversation = (overrides = {}) => ({
    ...
    messages: [
        { content: 'Hello there', created_at: '2024-01-15T10:00:00Z', sender_type: 'consumer' }
    ],
    ...overrides
});
...
describe('useNotifications', () => {
    ...
    describe('error handling', () => {
        ...
        it('should set error state when fetch fails', async () => {
            ...
            mockSelectReturn.mockResolvedValue({ data: null, error: new Error('Network error') });
    ...
    describe('message transformation', () => {
        ...
        it('should sort messages and take the latest', async () => {
            const mockData = [createMockConversation({
                messages: [
                    { content: 'Old message', created_at: '2024-01-14T10:00:00Z', sender_type: 'consumer' },
                    { content: 'Latest message', created_at: '2024-01-15T12:00:00Z', sender_type: 'agent' },
                    { content: 'Middle message', created_at: '2024-01-15T08:00:00Z', sender_type: 'consumer' }
                ]
            })];
            mockSelectReturn.mockResolvedValue({ data: mockData, error: null });
