        ...
        <div style={{ marginTop: 10, display: "grid", gap: 8 }}>
          {v1 && (
            <div style={{ border: "1px solid #E6ECFF", borderRadius: 8, padding: 8 }}>
              ...
              <button onClick={() => adopt(v1)} style={{ padding: "6px 10px", borderRadius: 8, border: "1px solid #1749D7", background: "#fff", color: "#1749D7" }}>採用（複製/送出）</button>
            </div>
          )}
          {v2 && (
            <div style={{ border: "1px solid #E6ECFF", borderRadius: 8, padding: 8 }}>
              ...
              <button onClick={() => adopt(v2)} style={{ padding: "6px 10px", borderRadius: 8, border: "1px solid #1749D7", background: "#fff", color: "#1749D7" }}>採用（複製/送出）</button>
            </div>
          )}
