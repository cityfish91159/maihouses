...
describe('InlineComposer', () => {
    ...
    it('renders correctly', () => {
        ...
        expect(screen.getByPlaceholderText(STRINGS.COMPOSER.PLACEHOLDER_FEED)).toBeDefined();
    ...
    it('expands on focus', () => {
        render(<InlineComposer {...defaultProps} />);
        const textarea = screen.getByPlaceholderText(STRINGS.COMPOSER.PLACEHOLDER_FEED);
    ...
    it('updates content on change', () => {
        render(<InlineComposer {...defaultProps} />);
        const textarea = screen.getByPlaceholderText(STRINGS.COMPOSER.PLACEHOLDER_FEED) as HTMLTextAreaElement;
    ...
    it('disables submit button when empty', () => {
        render(<InlineComposer {...defaultProps} />);
        const submitBtn = screen.getByText(STRINGS.COMPOSER.SUBMIT) as HTMLButtonElement;
