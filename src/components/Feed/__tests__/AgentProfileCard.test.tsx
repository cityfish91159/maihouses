...
describe('AgentProfileCard', () => {
    ...
    it('renders links correctly with ROUTES', () => {
        ...
        const uagLink = screen.getByRole('link', { name: STRINGS.AGENT.PROFILE.LINK_WORKBENCH });
        expect(uagLink).toHaveAttribute('href', ROUTES.UAG);

        const wallLink = screen.getByRole('link', { name: STRINGS.AGENT.PROFILE.LINK_WALL });
