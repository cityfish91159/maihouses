...
export const UagSummaryCard: React.FC<UagSummaryCardProps> = ({ data, className = '' }) => {
    return (
        <article className={`animate-in fade-in slide-in-from-bottom-4 flex flex-col gap-3 rounded-2xl border border-[#e6edf7] bg-white p-4 shadow-[0_4px_14px_rgba(12,34,80,0.04)] duration-500 ${className}`}>
            <div className="flex items-center gap-3 border-b border-[#f1f5f9] pb-2.5">
                <div className="flex size-10 items-center justify-center rounded-full border border-[#e6edf7] bg-[#faefe5] font-black text-[#92400e]">客</div>
            ...
            <div className="pt-1">
                ...
                <div className="grid grid-cols-3 gap-2">
                    ...
                    {/* B Grade */}
                    <div className="flex h-[34px] items-center justify-center rounded-full border border-[#e6edf7] text-[14px] font-semibold text-[#64748b]">
                        B 0
                    </div>
                    {/* No Reply */}
                    <div className="flex h-[34px] items-center justify-center rounded-full border border-[#e6edf7] text-[14px] font-semibold text-[#64748b]">
            ...
            <div className="mt-2.5 flex justify-end">
                <Link
                    to={ROUTES.UAG}
                    className="rounded-xl border-none bg-[#00385a] px-3 py-2 text-[14px] font-bold text-white no-underline transition-colors hover:bg-[#002840]"
                >
