  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await createLead({
        ...
        ...(form.preferredTime
          ? { preferredContactTime: form.preferredTime }
          : {}),
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="mt-1 text-sm opacity-90">
                {agentName} 將在 <span className="font-bold">10 分鐘內</span>{" "}
                回覆您
              </p>
            </div>
            <button
          ...
          {step === "success" ? (
            ...
            <div className="py-8 text-center">
              ...
              <p className="mb-4 text-slate-600">
                {agentName} 將在{" "}
                <span className="font-bold text-[#003366]">10 分鐘內</span>{" "}
                與您聯繫
              </p>
              <div className="rounded-xl bg-blue-50 p-4 text-left text-sm">
                <p className="mb-2 font-medium text-[#003366]">
                  📋 您的諮詢紀錄已保存：
                </p>
                ...
                <div className="flex gap-2">
                  {channelOptions.map((opt) => (
                    <button
                      ...
                      type="button"
                      onClick={() =>
                        setForm({ ...form, preferredChannel: opt.value })
                      }
