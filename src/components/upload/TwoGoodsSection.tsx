  ...
  return (
    ...
    >
        ...
        <div>
          ...
          <div className="mt-1.5 flex items-center justify-between px-1">
            ...
            >
              ...
              {validation.advantage1.valid ? '✓' : `(需 ${validation.advantage1.message})`}
            </span>
        ...
        <div>
          ...
          <div className="mt-1.5 flex items-center justify-between px-1">
            ...
            >
              ...
              {validation.advantage2.valid ? '✓' : `(需 ${validation.advantage2.message})`}
            </span>
        ...
        <div>
          ...
          <div className="mt-1.5 flex items-center justify-between px-1">
            ...
            >
              ...
              {validation.disadvantage.valid ? '✓' : `(需 ${validation.disadvantage.message})`}
            </span>
      ...
      {validation.contentCheck.hasIssues && (
        ...
        >
          <AlertTriangle
            className={validation.contentCheck.blockSubmit ? 'text-red-500' : 'text-yellow-600'}
            size={20}
          />
          <div>
            <p
