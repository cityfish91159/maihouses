            ...
            >
                <div className="flex items-center justify-between bg-gray-800 px-4 py-3 text-white">
                    ...
                    <div className="space-x-4 text-sm">
                        <span className="text-gray-400">原始: <span className="text-white">{formatSize(originalSize)}</span></span>
                        <span className="text-emerald-400">壓縮後: <span className="text-white">{formatSize(compressedSize)}</span> (-{saving}%)</span>
                        <button onClick={onClose} className="rounded bg-white/10 px-2 py-1 hover:bg-white/20">關閉</button>
                    </div>
                </div>
