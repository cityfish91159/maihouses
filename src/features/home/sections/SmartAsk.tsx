  ...
  className="max-h-[620px] min-h-[380px] overflow-y-auto rounded-[12px] border border-[#E5EDF5] bg-white p-4 shadow-inner md:max-h-[540px] md:min-h-[340px]"
      ...
      <div className="flex gap-2">
        <input
          ...
          onFocus={(e) => e.target.style.borderColor = '#009FE8'}
        ...
        <button
          ...
          style={{
            background: '#009FE8', /* Image Blue Primary Color */
            fontSize: 'var(--fs-sm)'
          }}
        >
          送出
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {reco.map((p) => (
              <article
                ...
                onMouseEnter={(e) => e.currentTarget.style.borderColor = '#009FE8'}
              ...
              >
                ...
                <a
                  ...
                  style={{ background: 'linear-gradient(135deg, #009FE8 0%, #0080C0 100%)' }}
                  aria-label="前往社區牆"
                >
                  看社區牆 →
                </a>
