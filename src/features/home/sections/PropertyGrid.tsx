...
export default function PropertyGrid({ q }: { q?: string }) {
  ...
  return (
  <section className="bg-white rounded-[28px] shadow-[10px_10px_24px_rgba(9,15,30,.16),_-10px_-10px_24px_rgba(255,255,255,.9)] p-6 md:p-8 transition-shadow hover:shadow-[var(--shadow-hover)]">
      <h3
