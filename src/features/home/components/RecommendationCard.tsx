...
export const RecommendationCard = memo(({ property }: RecommendationCardProps) => {
  return (
    <article
      className="rounded-xl border border-border-light bg-white p-3 transition-all hover:-translate-y-1 hover:border-brand hover:shadow-lg"
    >
      <div
      ...
      <div className="mb-2 text-base font-bold text-brand">
        NT$ {property.price} 萬
      </div>
      <a
