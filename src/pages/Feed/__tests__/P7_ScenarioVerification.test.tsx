...
describe('P7 Scenario Verification (L7+ Standard)', () => {
    ...
    it('Scenario 1: Viewer is Guest', async () => {
        ...
        const unlockBtn = screen.getByRole('button', { name: STRINGS.COMMUNITY.BTN_UNLOCK_GUEST });
    ...
    it('Scenario 2: Viewer is Member', async () => {
        ...
        const unlockBtn = screen.getByRole('button', { name: STRINGS.COMMUNITY.BTN_UNLOCK_USER });
        fireEvent.click(unlockBtn);
