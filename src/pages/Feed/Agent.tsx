                ...
                <main className="mx-auto flex w-full max-w-[560px] flex-1 flex-col gap-3 pb-20 md:pb-0">
                    ...
                    <article className="animate-in fade-in slide-in-from-bottom-4 flex flex-col gap-3 rounded-2xl border border-brand-100 bg-white p-4 shadow-card duration-500">
                        <div className="flex items-center gap-3 border-b border-slate-100 pb-2.5">
                            <div className="flex size-10 items-center justify-center rounded-full border border-badge-trust-border bg-badge-trust-bg font-black text-badge-trust-text">安</div>
                        ...
                        <div className="pt-1">
                            ...
                            <div className="flex flex-wrap gap-1.5">
                                <span className="rounded-full border border-grade-s-border bg-grade-s-bg px-2 py-0.5 text-[12px] text-grade-s-text">{STRINGS.AGENT.TRUST.TAG_COMPLETED}</span>
                        ...
                        <div className="flex gap-2">
                            ...
                            <button className="flex-1 rounded-lg border border-blue-700 bg-blue-700 px-3 py-2 text-sm font-extrabold text-white">{STRINGS.AGENT.TRUST.BTN_DETAIL}</button>
                        </div>
                    </article>
