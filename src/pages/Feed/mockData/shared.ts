...
/** Helper for hours */
export const mockTimestampHoursAgo = (hours: number): string => mockTimestamp(hours * 60);

/** Helper for days */
export const mockTimestampDaysAgo = (days: number): string => mockTimestamp(days * 24 * 60);
