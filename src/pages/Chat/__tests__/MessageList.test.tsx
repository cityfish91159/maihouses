...
describe('MessageList', () => {
  it('renders loading skeleton', () => {
    const { container } = render(
      <MessageList messages={[]} currentSender="agent" isLoading />
    );
  ...
  it('renders error state', () => {
    render(
      <MessageList messages={[]} currentSender="agent" error={new Error('boom')} />
    );
  ...
  it('aligns current sender message to the right', () => {
    const { container } = render(
      <MessageList messages={[baseMessage]} currentSender="agent" />
    );
  ...
  it('aligns counterpart message to the left', () => {
    ...
    const { container } = render(
      <MessageList messages={[otherMessage]} currentSender="agent" />
    );
