    ...
    <div className={`${styles["deai-v2"]} ${styles["deai-v2-page"]}`}>
      ...
      <header className={styles["deai-v2-header"]}>
        <div className={styles["deai-v2-header-inner"]}>
          ...
          <nav className={styles["deai-v2-nav"]}>
            <span
              className={`${styles["deai-v2-badge"]} ${styles["deai-v2-badge--active"]}`}
            >
              UAG 客戶雷達
            </span>
      ...
      <main className={styles["deai-v2-container"]}>
        <div className={styles["deai-v2-grid"]}>
          {/* [1] Radar Card - span 3 */}
          <section
            className={`${styles["deai-v2-card"]} ${styles["deai-v2-span-3"]}`}
          >
            ...
            <div className={styles["deai-v2-cluster"]}>
              ...
              {liveLeads.map((lead) => {
                ...
                return (
                  ...
                  >
                    {/* Grade Badge */}
                    <div className={styles["deai-v2-bubble-grade"]}>
                      {lead.grade}
                    </div>

                    {/* Content */}
                    <span className={styles["deai-v2-bubble-id"]}>
                      {leadLabels[lead.id]}
                    </span>
                    <span className={styles["deai-v2-bubble-intent"]}>
                      {lead.intent}%
                    </span>

                    {/* Label */}
                    <div className={styles["deai-v2-bubble-label"]}>
                      {lead.prop}
                    </div>
                  </div>
                );
          ...
          <section
            className={`${styles["deai-v2-panel"]} ${styles["deai-v2-span-3"]}`}
          >
            <div className={styles["deai-v2-panel-head"]}>
              {selectedLead
                ? `${leadLabels[selectedLead.id]} 名單詳情`
                : "點選氣泡查看詳情"}
            </div>
            <div className={styles["deai-v2-panel-body"]}>
              {selectedLead ? (
                <>
                  ...
                  <div className={styles["deai-v2-stat"]}>
                    <span className={styles["deai-v2-stat-label"]}>
                      物件偏好
                    </span>
                    <span className={styles["deai-v2-stat-value"]}>
                      {selectedLead.prop}
          ...
          <section
            className={`${styles["deai-v2-card"]} ${styles["deai-v2-span-6"]}`}
          >
            <div className={styles["deai-v2-card-header"]}>
              <div>
                <h2 className={styles["deai-v2-card-title"]}>
                        ...
                        <tr key={lead.id}>
                          <td>
                            <div className={styles["deai-v2-table-lead"]}>
                              ...
                              <div>
                                <div className={styles["deai-v2-table-name"]}>
                                  {lead.name}
                                </div>
                                <div className={styles["deai-v2-table-prop"]}>
                                  {lead.prop}
                                </div>
                              </div>
                            </div>
                          ...
                          <td>
                            <div className={styles["deai-v2-progress-info"]}>
                              ...
                              <span className={styles["deai-v2-countdown"]}>
                                {timeDisplay}
                              </span>
                            </div>
              ...
              {mockListings.map((item) => (
                <article key={item.id} className={styles["deai-v2-listing"]}>
                  ...
                  <div className={styles["deai-v2-listing-info"]}>
                    <div className={styles["deai-v2-listing-title"]}>
                      {item.title}
                    </div>
            ...
            <div className={styles["deai-v2-feed"]}>
              {mockFeed.map((post) => (
                <article key={post.id} className={styles["deai-v2-feed-post"]}>
                  <div className={styles["deai-v2-feed-title"]}>
                    {post.title}
                  </div>
            ...
            <div className={styles["deai-v2-report-step"]}>
              ...
              <div className={styles["deai-v2-report-list"]}>
                {mockListings.slice(0, 2).map((item) => (
                  <button
                    key={item.id}
                    className={styles["deai-v2-report-item"]}
                  >
                    <div
                    ...
                    <div className={styles["deai-v2-report-info"]}>
                      <div className={styles["deai-v2-report-title"]}>
                        {item.title}
                      </div>
                      <div className={styles["deai-v2-report-meta"]}>
                        {item.tags[0]}
                      </div>
                    </div>
          ...
          >
            ...
            <div className={styles["deai-v2-trust-cases"]}>
              {mockTrustCases.map((c) => (
                ...
                >
                  <div className={styles["deai-v2-trust-case-name"]}>
                    {c.buyerName}
                  </div>
                  <div className={styles["deai-v2-trust-case-prop"]}>
                    {c.propertyTitle}
                  </div>
                  <div className={styles["deai-v2-trust-case-step"]}>
                    M{c.currentStep}
                  </div>
                </button>
              ))}
            ...
            <div className={styles["deai-v2-trust-stats"]}>
              <div className={styles["deai-v2-trust-stat"]}>
                <div className={styles["deai-v2-trust-stat-value"]}>
                  {mockTrustCases.length}
                </div>
                <div className={styles["deai-v2-trust-stat-label"]}>
                  進行中案件
                </div>
              </div>
              <div className={styles["deai-v2-trust-stat"]}>
