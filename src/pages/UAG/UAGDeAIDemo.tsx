              ...
              <>
                ...
                <div className={styles['deai-stat']}>
                  ...
                  <span className={styles['deai-stat-value']}>
                    <span
                      className={
                        styles[`deai-badge--${selectedLead.grade.toLowerCase()}`] ||
                        styles['deai-badge']
                      }
                    >
                ...
                <div className={styles['deai-stat']}>
                  <span>意向度</span>
                  <span className={styles['deai-stat-value']}>{selectedLead.intent}%</span>
                </div>
                <div className={styles['deai-stat']}>
                  <span>物件偏好</span>
                  <span className={styles['deai-stat-value']}>{selectedLead.prop}</span>
                </div>
                <div className={styles['deai-stat']}>
                  <span>預算範圍</span>
                  <span className={styles['deai-stat-value']}>1,200-1,500萬</span>
                </div>
