...
| 項目 | 得分 | 說明 |
|------|------|------|
| UP-1.1 usePropertyDraft Hook | 24/25 | userId key、版本號、過期機制、時間戳、遷移 |
| UP-1.2 整合至 UploadContext | 24/25 | supabase userId 注入、匿名→登入自動遷移 |
| UP-1.3 還原草稿 UI | 24/25 | 預覽標題/時間 + 捨棄草稿 + 錯誤回饋 |
| 測試覆蓋 | 23/25 | 新增單元測試，E2E 待補 |
