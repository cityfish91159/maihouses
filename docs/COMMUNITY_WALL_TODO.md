...
**完成時間**: -
**審計評分**: 78/100 (Google v2.3 審查：6 項新建議)

**設計**: 帶「信心分數」的解析器，MaiMai 根據分數展現不同情緒。

| ID | 子任務 | 狀態 | 驗收標準 |
|:---|:---|:---:|:---|
| IM-2.1 | 價格解析 (售/租通用) | ⚠️ | 需統一 simpleRentMatch 為萬/月 |
| IM-2.2 | 坪數解析 | ✅ | 已支援模糊格式 |
| IM-2.3 | 格局解析 | ⚠️ | 需支援 1+1房、2.5房 |
| IM-2.4 | 地址解析 (全台通用) | ⚠️ | 需支援無門牌寬鬆模式 |
| IM-2.5 | 標題擷取 | ⚠️ | 需放寬房產詞限制 |
