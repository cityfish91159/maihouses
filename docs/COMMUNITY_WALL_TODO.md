...
### UP-3: 圖片管理重構 ✅ (2025-12-22)
- UP-3.1: `ManagedImage` 介面 (`id`, `file`, `previewUrl`, `isCover`)
- UP-3.2: `uploadReducer.ts` 使用 `managedImages` 取代 `imageFiles`
- UP-3.3: `setCover(id)` 功能 + MediaSection ⭐ 按鈕
- UP-3.4: `getSortedImages()` 確保封面為 `images[0]`
- Build: ✅ | Tests: 250 passed
