...
**完成時間**: 2025-12-29
**審計評分**: 100/100 (已修復 Google 審查之 9 大缺失)

**設計**: 帶「信心分數」的解析器，MaiMai 根據分數展現不同情緒。

| ID | 子任務 | 狀態 | 驗收標準 |
|:---|:---|:---:|:---|
| IM-2.1 | 價格解析 (售/租通用) | ✅ | 已正規化單位 (萬/月) |
| IM-2.2 | 坪數解析 | ✅ | 已支援模糊格式 (約/含車位) |
| IM-2.3 | 格局解析 | ✅ | 已支援 1.5衛/0廳/開放式 |
| IM-2.4 | 地址解析 (全台通用) | ✅ | 已正規化台/臺 |
| IM-2.5 | 標題擷取 | ✅ | 已改進評分策略 |
| IM-2.6 | 591 物件 ID 擷取 | ✅ | 匹配 `detail/123456` 等 |
| IM-2.7 | 信心分數計算 | ✅ | fieldsFound 計分邏輯修正完畢 |

#### IM-2 審查記錄 (Google 處長級) ✅ 已全數修復

| # | P | 問題 | 狀態 |
|:---:|:---:|:---|:---|
| 2.1 | 0 | 價格未正規化 | ✅ 已修復 |
| 2.2 | 0 | fieldsFound 與分數規格不一致 | ✅ 已修復 |
| 2.3 | 1 | 格局容錯不足 (1.5衛/0廳) | ✅ 已修復 |
| 2.4 | 1 | 價格/坪數缺模糊 fallback | ✅ 已修復 |
| 2.5 | 2 | 標題易誤殺 | ✅ 已修復 |
| 2.6 | 2 | 地址仍未正規化台/臺 | ✅ 已修復 |
| 2.7 | 2 | detect591 覆蓋不足 | ✅ 已修復 |
| 2.8 | 3 | 信心/欄位提示與 UX | ✅ 已修復 |
| 2.9 | 3 | 測試尚未覆蓋 edge cases | ✅ 已覆蓋 (48/48 通過) |
